...
<body class="sf-home">
	...
	Rent or Buy: <input type="checkbox" data-role="flipswitch" class="checkRent" name="rentbuy" id="switch"><br>
	...
	Heat Usage: <input type="range" name="heatusage" id="heatusage" value="50" min="0" max="100"><br>
	...
	Power Usage: <input type="range" name="powerusage" id="powerusage" value="50" min="0" max="100"><br>
	</form>
</body>
